...
from app_proyectoFinal.views import atletaCreateView, atletaDetailView, atletaDeleteView, atletaListView, atletaUpdateView, buscar, inicio, atleta_delete, atleta_update ,atleta_busqueda, entrenador, rutina
